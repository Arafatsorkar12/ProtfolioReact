                ...
                <div className="container">
                    ...
                    <div className="row pb-3">
                        <div className="col-lg-4 col-md-6 text-center mb-5">
                            ...
                            <p>
                                {/* Justo sit justo eos amet tempor amet clita amet ipsum eos elitr. Amet lorem lorem lorem
                                est amet labore eirmod erat clita */}
                                </p>
                        ...
                        {/* <div className="col-lg-4 col-md-6 text-center mb-5">
                            ...
                            <p>Justo sit justo eos amet tempor amet clita amet ipsum eos elitr. Amet lorem lorem lorem
                                est amet labore eirmod erat clita</p>
                            <a className="border-bottom border-primary text-decoration-none" href="">Read More</a>
                        </div>
                        <div className="col-lg-4 col-md-6 text-center mb-5">
                            <div className="d-flex align-items-center justify-content-center mb-4">
